...
public class DDALineDrawer implements LineDrawer {
    ...
    @Override
    public void drawDottedLine(ScreenPoint p1, ScreenPoint p2, Color color) {
        int x1 = p1.getX(), y1 = p1.getY();
        int x2 = p2.getX(), y2 = p2.getY();
        double dx = x2 - x1;
        double dy = y2 - y1;
    ...
    @Override
    public void drawDottedLine(ScreenPoint p1, ScreenPoint p2) {
        drawDottedLine(p1, p2, Color.BLUE);
    }
}
